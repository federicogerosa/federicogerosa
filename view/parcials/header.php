...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    ...
    <div class="mdl-layout__drawer">
        ...
        <nav class="mdl-navigation">
            <a class="mdl-navigation__link" href="/listaEsercenti" METHODS="get"><i class="material-icons md-ip">list</i> Lista
                esercenti</a>

            <a class="mdl-navigation__link" href="/aggiungiEsercente"><i class="material-icons md-ip">person_add</i>
                Aggiungi esercente</a>

            <a class="mdl-navigation__link" href="/listaUtenti" METHODS="get"><i class="material-icons md-ip">List</i>
                Utenti</a>

            <a class="mdl-navigation__link" href="/listaQuestionari" METHODS="get"><i
                        class="material-icons md-ip">list</i>
                Lista Questionari</a>
